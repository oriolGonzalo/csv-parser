...
## 1. app de carga de un fichero CSV en una base de datos y visualiza datos en el navegador
...
```$ php -f import.php```
  ...
  * Se importarán los datos del archivo a la base de datos starships.sqlite
  ...
  Nota: El archivo de base de datos resultante se encontrará en el directorio raíz del proyecto

* Para consultar los datos desde el navegador, iniciamos el servidor de php con el siguiente comando:
...
* El script generará un archivo CSV en el mismo directorio ```bin```. Podemos proceder a su consulta. 